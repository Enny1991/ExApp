...
public class UDPRunnableStream implements Runnable {
    ...
    private int port;
    protected InetAddress IaddressDirect;
    ...
    UDPRunnableStream(GlobalNotifier bf,GlobalNotifierUDP monitor,String add,InetAddress addDirect,int port, int portDir,MainActivity act) {
        //TODO set up Socket
